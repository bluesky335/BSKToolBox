#
#  Be sure to run `pod spec lint BSKToolBox.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
				   这是一个我在开发过程中的一些自己写的方便的小工具的总结，包括一些封装好的方便的方法、工具类、视图和控制器等等。
  DESC

  s.homepage     = "https://github.com/bluesky335/BSKToolBox"
